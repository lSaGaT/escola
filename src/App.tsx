...
import Matricula from '@/src/pages/Matricula';
...
const PAGE_QUOTES = {
  ...
  '/professor-cadastro': {
    ...
    subtitle: "Bem-vindo ao time da Escolinha"
  },
  '/admin': {
...
type Page = '/' | '/agenda' | '/mensagens' | '/alunos' | '/fotos' | '/matricula' | '/professor-cadastro' | '/admin';

export default function App() {
  const navigate = useNavigate();
  const location = useLocation();
  const currentPage = (location.pathname as Page) || '/';
  ...
  if (currentPage === '/professor-cadastro' && !user) {
    return (
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-[20%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-8 text-white">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold leading-tight mb-2">{PAGE_QUOTES[currentPage]?.title || PAGE_QUOTES['/'].title}</h2>
            <p className="text-sm opacity-90">{PAGE_QUOTES[currentPage]?.subtitle || PAGE_QUOTES['/'].subtitle}</p>
          </div>
      ...
      <div className="w-full lg:w-[80%] min-h-screen bg-[#FFF5F5] flex flex-col">
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          <AnimatePresence mode="wait">
            ...
            >
              {(currentPage === '/' || currentPage === '/agenda') && role && (
        ...
        <div className="p-4 border-t border-red-100 text-center text-xs text-slate-500">
          ...
          <p>
            Sistema desenvolvido por{' '}
            <a href="https://nodoprime.com.br" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:underline">
              Nodo Prime
            </a>
          </p>
        </div>
